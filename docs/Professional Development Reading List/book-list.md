...
3. "Becoming an Effective Software Engineering Manager" by James Stanier

4. "The Engineering Leader" by Cate Huston
...
3. Head First "Design Patterns" 2nd Edition by Freeman & Robson

4. "Designing Data Intensive Applications" by Kleppmann

5. "Building Microservices" by Newmann 

6. "Fundamentals of Data Engineering" by Reis & Housley

7. "Frontend Architecture for Design Systems"

8. "Front-End Web Development" by Chris Aquino and Todd Gandee

9. Deque University classes on Accessibility

10. User Interface Design and Prototyping certificate from Microsoft

11. "Modern Software Engineering" by Dave Farley
...
17. "The Staff Engineer's Path" by Tanya Reilly

18. Cornell's System Design certification
...
2. Gumroad
3. Libro.fm 
    - 100% employee-owned Social Purpose Corporation
4. Local Libraries via Libby or Hoopla
